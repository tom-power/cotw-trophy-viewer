...
def hashlittle2(data, initval=0, initval2=0):
    ...
    if lenpos == 12: c += (
                (data[p + 8]) + ((data[p + 9]) << 8) + ((data[p + 10]) << 16) + ((data[p + 11]) << 24)); b += (
                (data[p + 4]) + ((data[p + 5]) << 8) + ((data[p + 6]) << 16) + ((data[p + 7]) << 24)); a += (
                (data[p + 0]) + ((data[p + 1]) << 8) + ((data[p + 2]) << 16) + ((data[p + 3]) << 24));
    if lenpos == 11: c += ((data[p + 8]) + ((data[p + 9]) << 8) + ((data[p + 10]) << 16)); b += (
                (data[p + 4]) + ((data[p + 5]) << 8) + ((data[p + 6]) << 16) + ((data[p + 7]) << 24)); a += (
                (data[p + 0]) + ((data[p + 1]) << 8) + ((data[p + 2]) << 16) + ((data[p + 3]) << 24));
    if lenpos == 10: c += ((data[p + 8]) + ((data[p + 9]) << 8)); b += (
                (data[p + 4]) + ((data[p + 5]) << 8) + ((data[p + 6]) << 16) + ((data[p + 7]) << 24)); a += (
                (data[p + 0]) + ((data[p + 1]) << 8) + ((data[p + 2]) << 16) + ((data[p + 3]) << 24));
    if lenpos == 9:  c += ((data[p + 8])); b += (
                (data[p + 4]) + ((data[p + 5]) << 8) + ((data[p + 6]) << 16) + ((data[p + 7]) << 24)); a += (
                (data[p + 0]) + ((data[p + 1]) << 8) + ((data[p + 2]) << 16) + ((data[p + 3]) << 24));
    if lenpos == 8:  b += ((data[p + 4]) + ((data[p + 5]) << 8) + ((data[p + 6]) << 16) + ((data[p + 7]) << 24)); a += (
                (data[p + 0]) + ((data[p + 1]) << 8) + ((data[p + 2]) << 16) + ((data[p + 3]) << 24));
    if lenpos == 7:  b += ((data[p + 4]) + ((data[p + 5]) << 8) + ((data[p + 6]) << 16)); a += (
                (data[p + 0]) + ((data[p + 1]) << 8) + ((data[p + 2]) << 16) + ((data[p + 3]) << 24));
    if lenpos == 6:  b += (((data[p + 5]) << 8) + (data[p + 4])); a += (
                (data[p + 0]) + ((data[p + 1]) << 8) + ((data[p + 2]) << 16) + ((data[p + 3]) << 24))
    if lenpos == 5:  b += ((data[p + 4])); a += (
                (data[p + 0]) + ((data[p + 1]) << 8) + ((data[p + 2]) << 16) + ((data[p + 3]) << 24));
