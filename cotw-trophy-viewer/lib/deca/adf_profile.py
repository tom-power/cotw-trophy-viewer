...
PRIMITIVES = [typedef_s8, typedef_u8, typedef_s16, typedef_u16, typedef_s32, typedef_u32, typedef_s64, typedef_u64,
              typedef_f32, typedef_f64]
...
class AdfArray:
    def __init__(self, name: str, population: int, group: int, length: int, header_start_offset: int,
                 header_length_offset: int, header_array_offset: int, array_start_offset: int, array_end_offset: int,
                 rel_array_start_offset: int, rel_array_end_offset: int, male_indices: List[int],
                 female_indices: List[int]) -> None:
        self.name = name
...
class Animal:
    def __init__(self, gender: str, weight: float, score: float, is_great_one: bool,
                 visual_variation_seed: int) -> None:
...
def find_population_array_offsets(offsets: dict, result: List[dict] = [], org_path: str = "", prev_key: str = "",
...
def create_array(offset: dict, instance_offset: int, data: bytearray = None, population: int = 0,
                 group: int = 0) -> AdfArray:
