...
RESERVES_ANIMALS_CLASSES = {
    ...
    Reserve.SILVER_RIDGE_PEAKS: {
        ...
        2: [],
        3: [],
        4: [AnimalType.PRONG_HORN, AnimalType.MOUNTAIN_GOAT, AnimalType.BIGHORN_SHEEP],
        5: [AnimalType.PUMA],
    ...
    Reserve.RANCHO_DEL_ARROYO: {
        ...
        4: [AnimalType.COLLARED_PECCARY, AnimalType.BIGHORN_SHEEP, AnimalType.WHITETAIL_DEER, AnimalType.PRONG_HORN],
        5: [],
        6: [AnimalType.MULE_DEER],
        7: [],
        8: [],
    ...
    Reserve.MISSISSIPPI_ACRES_PRESERVE: {
        ...
        3: [],
        4: [AnimalType.WHITETAIL_DEER, AnimalType.FERAL_PIG],
        5: [],
    ...
    Reserve.NEW_ENGLAND_MOUNTAINS: {
        ...
        2: [AnimalType.RED_FOX, AnimalType.GRAY_FOX, AnimalType.COYOTE, AnimalType.RACCOON],
        3: [AnimalType.BOBCAT],
        4: [AnimalType.WHITETAIL_DEER],
        5: [],
        6: [],
    ...
    Reserve.ASKIY_RIDGE: {
        ...
        2: [],
        3: [AnimalType.NORTH_AMERICAN_BEAVER],
        4: [AnimalType.BIGHORN_SHEEP, AnimalType.WHITETAIL_DEER, AnimalType.MOUNTAIN_GOAT, AnimalType.PRONG_HORN],
        5: [AnimalType.GRAY_WOLF],
        6: [AnimalType.WOODLAND_CARIBOU, AnimalType.MULE_DEER],
        7: [AnimalType.BLACK_BEAR],
        8: [AnimalType.MANITOBAN_ELK, AnimalType.MOOSE],
