...
RESERVES_ANIMALS_CLASSES = {
    ...
    Reserve.CUATRO_COLINAS: {
        ...
        4: [AnimalType.IBERIAN_MOUFLON, AnimalType.RONDA_IBEX, AnimalType.BECEITE_IBEX, AnimalType.GREDOS_IBEX,
            AnimalType.SOUTHEASTERN_SPANISH_IBEX,
    ...
    Reserve.ASKIY_RIDGE: {
        1: [AnimalType.DUSKY_GROUSE, AnimalType.NORTHERN_PINTAIL, AnimalType.WOOD_DUCK, AnimalType.SNOW_GOOSE,
            AnimalType.CANADA_GOOSE, AnimalType.MALLARD, AnimalType.RING_NECKED_PHEASANT],
        2: [],
        3: [AnimalType.NORTH_AMERICAN_BEAVER],
        4: [AnimalType.BIGHORN_SHEEP, AnimalType.WHITETAIL_DEER, AnimalType.MOUNTAIN_GOAT, AnimalType.PRONGHORN],
        5: [AnimalType.GREY_WOLF],
